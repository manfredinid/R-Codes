...
rate.plot <- ggplot() +
  geom_line(data = rate.earmarked, aes(x = time(rate.earmarked), y = , rate.earmarked, linetype ="dashed")) +
  geom_line(data = rate.nonearmarked, aes(x = time(rate.earmarked), y = rate.nonearmarked, linetype = "solid")) +
   geom_line(data = rate.gap, aes(x = time(rate.earmarked), y = rate.gap), color="red") +
    geom_line(size=0.7) +
    theme_minimal()+
  ...
  scale_linetype_manual(name = '', values = rep(c('solid', 'dashed'),2),labels = c("earmarked", "non-earmarked")) 
