...
```{r}
tjlp.union <- ts.union(tjlp,tjlp.6,selic,rate.PJ,tjlp.15)

PJ.nonearmarked <- cbind(rate.PJ,rate.nonearmarked)
```
...
autoplot(tjlp.union)+
  ...
  scale_color_manual(name = '',values = c("blue", "#00AFBB","black", "red","grey"),labels = c("TJLP", "TJLP+6%","Selic", "nonearmarked","TJLP+1.5%"))+
  xlab("") + 
