...
bndes_quanter <- deflate(bndes_quarter, actual_dates_quarter , '01/2003', index = 'ipca')
pib_quarter <- deflate(pib_quarter, actual_dates_quarter , '01/2003', index = 'ipca')
fbcf_quanter <- deflate(fbcf_quarter, actual_dates_quarter , '01/2003', index = 'ipca')
...
```{r}
Qbndes_3rt <- cbind(bndes_quanter,pib_quarter,fbcf_quarter)
